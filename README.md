# Awesome boilerplates with stars
...
* [Android Architecture Blueprints](https://github.com/googlesamples/android-architecture) ⭐ 45,842 | 🐛 227 | 🌐 Kotlin | 📅 2026-09-18 Demonstrates a basic Model-View-Presenter architecture and showcases various TODO app implementations.
...
* [AndroidKickststarter](https://github.com/e-biz/androidkickstartr) ⭐ 601 | 🐛 41 | 🌐 Java | 📅 2023-12-18 Framework kickstarts development which help you focus on coding.
* [material-design-icons-adt-template](https://github.com/intrications/material-design-icons-adt-template) ⭐ 434 | 🐛 0 | 🌐 Python | 📅 2016-07-11 Android Studio / Eclipse ADT template for material-design-icons resources.
* [Android Quickstart](https://github.com/googledrive/android-quickstart) ⚠️ Archived Quickstart application showing the Google Drive API for Android.
* [Android Webview Sample App](https://github.com/tscolari/android-webview-sample-app) ⚠️ Archived Webview Sample App
* [Android Bootstrap](https://github.com/AndroidBootstrap/android-bootstrap) ⭐ 1 | 🐛 0 | 📅 2022-01-03 A template/bootstrap/boilerplate application that includes tons of great open source tools and frameworks.
...
* [Swift 5 Module Template](https://github.com/fulldecent/swift5-module-template) ⭐ 487 | 🐛 2 | 🌐 Swift | 📅 2025-09-28 Boilerplate for reusable Swift 5 modules.
...
* [Mega Boilerplate](https://github.com/sahat/megaboilerplate) ⭐ 3,796 | 🐛 79 | 🌐 CSS | 📅 2022-07-22 Fullstack boilerplate generator with support for Node.js, a static site, or an Electron app.

* [Yeoman](https://github.com/yeoman) The web's scaffolding tool for modern webapps. Includes many generators to get started.

* [NodeJS](#node-js)
  * [Hackathon Starter](https://github.com/sahat/hackathon-starter) ⭐ 35,254 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-22 A boilerplate for Node.js web applications.
  * [Node-Express-Mongoose Boilerplate](https://github.com/hagopj13/node-express-mongoose-boilerplate) ⭐ 7,664 | 🐛 111 | 🌐 JavaScript | 📅 2024-07-08 - A boilerplate for building production-ready RESTful APIs using Node.js, Express, and Mongoose.
...
* [AngularJS](#angular-js)
  ...
  * [ng-boilerplate](https://github.com/ngbp/ngbp) ⭐ 3,879 | 🐛 158 | 🌐 JavaScript | 📅 2019-07-02 An opinionated kickstarter for AngularJS projects.
...
* [ReactJS](#react-js)
  * [React JS Hot loader Boilerplates](https://github.com/gaearon/react-hot-loader/tree/master/docs#starter-kits) ⭐ 12,159 | 🐛 462 | 🌐 JavaScript | 📅 2023-02-10 React hot loader starter kits
  * [React Redux Universal Hot Example](https://github.com/erikras/react-redux-universal-hot-example) ⭐ 12,066 | 🐛 419 | 🌐 JavaScript | 📅 2024-08-02 A starter boilerplate for a universal webapp using express, react, redux, webpack, and react-transform
  ...
  * [React Boilerplate](https://github.com/petehunt/react-boilerplate) ⭐ 540 | 🐛 6 | 🌐 JavaScript | 📅 2022-09-22 Boilerplate for creating a React npm package
  * [Library Boilerplate](https://github.com/gaearon/library-boilerplate) ⭐ 382 | 🐛 7 | 🌐 JavaScript | 📅 2016-02-28 An opinionated boilerplate for React libraries including ESLint, Mocha, Babel, Webpack and an example powered by Webpack Dev Server and React Hot Loader
  * [Flask React Boilerplate](https://github.com/alexkuz/flask-react-boilerplate) ⚠️ Archived Flask and react Boilerplate
  * [Coffee React Quickstart ](https://github.com/KyleAMathews/coffee-react-quickstart) ⭐ 254 | 🐛 10 | 🌐 CoffeeScript | 📅 2016-03-27 Quickstart for building React single page apps using Coffeescript, Gulp, Webpack, and React-Router
  * [React NPM Component Starter](https://github.com/yogaboll/react-npm-component-starter) ⭐ 169 | 🐛 1 | 🌐 JavaScript | 📅 2019-01-22 A minimal boilerplate for building a React component for NPM
  * [Boilerplate Webpack React](https://github.com/tcoopman/boilerplate-webpack-react) ⭐ 44 | 🐛 2 | 🌐 JavaScript | 📅 2016-01-16 Boilerplate project for Reactjs with webpack, gulp and stylus
  * [post3ree-boilerplate](https://github.com/hex22a/post3ree-boilerplate) ⚠️ Archived Boilerplate for a universal application using 3REE stack (React, Redux, RethinkDB, Express) + PostCSS
  * [React Typescript npm boilerplate](https://github.com/Sivakumar00/react-typescript-npm-boilerplate) ⭐ 6 | 🐛 1 | 🌐 TypeScript | 📅 2021-10-05 Powerful react typescript npm component boilerplate built with rollup.js, storybook, jest unit test, tree-shaking and airbnb eslint rules
  * [React Boilerplate](https://github.com/rackt/react-boilerplate) React boilerplate with React Router and webpack

* [HyperApp](#hyperapp)
  * [hyperapp-boilerplate](https://github.com/tzellman/hyperapp-boilerplate) ⭐ 46 | 🐛 13 | 🌐 JavaScript | 📅 2022-12-04 Boilerplate showing how to create a production-ready Hyperapp application.

* [Backbone](#backbone)
  * [Yeoman Backbone Generator](https://github.com/yeoman/generator-backbone) ⚠️ Archived Yeoman generator for Backbone.
  * [Backbone Boilerplates](https://github.com/addyosmani/backbone-boilerplates) ⭐ 485 | 🐛 10 | 🌐 JavaScript | 📅 2013-04-02 Backbone Boilerplates by Addy Osmani.
  * [benm](https://github.com/shorttompkins/benm) ⭐ 168 | 🐛 5 | 🌐 JavaScript | 📅 2017-01-02 Boilerplate web app using Backbone.js, ExpressJS, node.js, MongoDB.

* [Jquery](#jquery)
  * [Generator Jquery Boilerplate](https://github.com/jquery-boilerplate/generator-jquery-boilerplate) ⭐ 148 | 🐛 2 | 🌐 JavaScript | 📅 2016-05-05 Yeoman Generator for jQuery Boilerplate.

* [Polymer](#polymer)
  * [Polymer Starter Kit](https://github.com/PolymerElements/polymer-starter-kit) ⚠️ Archived A starting point for Polymer 1.0 apps.
  * [Yeoman Polymer Generator](https://github.com/yeoman/generator-polymer) ⚠️ Archived Yeoman's polymer Generator
...
* [Electron](#electron)
  * [Electron React Boilerplate](https://github.com/electron-react-boilerplate/electron-react-boilerplate) ⭐ 24,252 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-15 A Foundation for Scalable Electron Apps
...
* [Webstack-micro](https://github.com/ferbs/webstack-micro) ⚠️ Archived Demo/starter for full-stack web app using microservices architecture, with API Gateway, centralized authentication, background workers, and WebSockets.

## Python

*Boilerplates and templates for Python*

* [CookieCutter](https://github.com/audreyr/cookiecutter#python) ⭐ 25,104 | 🐛 318 | 🌐 Python | 📅 2026-04-01 List of various python templates by Audrey.
...
* [GoogleAppEngine Webapp2 Boilerplate](https://github.com/coto/gae-boilerplate) ⭐ 681 | 🐛 43 | 🌐 Python | 📅 2024-10-20 A Complete boilerplate for Python Webapp2 on Google App Engine
...
* [Django Starter Template](https://github.com/fasouto/django-starter-template) ⭐ 158 | 🐛 4 | 🌐 Python | 📅 2026-09-18 An easy to use project template for Django that follows best practices.
...
* [Laravel Angular CouchDB](https://github.com/melvin0008/laravel-angular) ⭐ 10 | 🐛 0 | 🌐 JavaScript | 📅 2014-12-21 Laravel Angular CouchDB Boilerplate

## Ruby

*Boilerplates and templates for Ruby*

* [AngularJS Rails Templates](https://github.com/pitr/angular-rails-templates) ⭐ 560 | 🐛 9 | 🌐 Ruby | 📅 2025-11-23 Rails and Angular Tempate.
...
* [ASP.NET Boilerplate](https://github.com/aspnetboilerplate/aspnetboilerplate) ⭐ 12,000 | 🐛 62 | 🌐 C# | 📅 2026-09-22 ASP.NET Boilerplate is a starting point for new modern web applications using best practices and most popular tools.

## Go

*Boilerplates and templates for Go*

* [Go React JSX Boilerplate](https://github.com/sharath/go-react-boilerplate) ⭐ 5 | 🐛 0 | 🌐 HTML | 📅 2018-09-19 Starter code for a React + Go web application
...
* [Boilerplate with Webpack](https://github.com/fstanis/webextensions-webpack-boilerplate) ⭐ 69 | 🐛 4 | 🌐 JavaScript | 📅 2018-01-11 Using Webpack JS module manager
...
* [HTML Website Template](https://github.com/fulldecent/html-website-template) ⭐ 41 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-11 Starting point for collaboratively-edited HTML websites
...
* [Yasnippet](https://github.com/capitaomorte/yasnippet) ⭐ 2,958 | 🐛 161 | 🌐 Emacs Lisp | 📅 2025-06-04 A template system for Emacs.
...
# [Contributing](https://github.com/melvin0008/awesome-projects-boilerplates/blob/master/CONTRIBUTING.MD) ⭐ 1,408 | 🐛 19 | 📅 2024-08-06
